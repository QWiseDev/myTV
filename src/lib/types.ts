import { AccessLog } from './access-log'; // 从访问日志服务导入
import { AdminConfig } from './admin.types';

// 重新导出访问日志类型以方便使用
export type { AccessLog, GeolocationAccessLog } from './access-log';
